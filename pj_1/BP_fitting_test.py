...
X_valid, y_valid = create_data(func=func, interval=interval, sample_num=valid_num, noise=noise)
...
batch_size = 16
layers = [1, 16, 32, 1]
BP_net = back_propagation(layers=layers, batch_size=batch_size, X_valid=X_valid, y_valid=y_valid)
